...
class CommonView
{
    ...
    private function LocalTime2Seconds($RSQL_Time__given)
    {
        ...
        return $sign . (substr($RSQL_Time__given, -2) + substr($RSQL_Time__given, -5, 2) * 60 + substr($RSQL_Time__given, 0, strlen($RSQL_Time__given) - 6) * 60 * 60);
    }
